...
@push('scripts')
  <script>
              ...
              if (xhr.status === 422) {
                ...
                $.each(errors, function (key, value) {
                  var inputField = $('[name="' + key + '"]');
                    inputField.after('<div class="text-danger">' + value[0] + '</div>');
                });
              }
            }
        });
    ...
    $(document).on('click', '.delete', function () {
        ...
        var deleteUrl = "{{ route('penyisihan.provinsi.destroy', ':id') }}".replace(':id', provinsiId);
